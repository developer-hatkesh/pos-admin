...
class Party extends Model
{
    ...
    protected $fillable = ['company_id', 'type', 'name', 'phone', 'email', 'address_line1', 'address_line2', 'city', 'postcode', 'country', 'vat_number', 'payment_terms', 'credit_limit', 'opening_balance', 'balance_type', 'ledger_id', 'status'];
